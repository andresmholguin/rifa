...
const FormComprador = () => {
  ...
  return <div className="h-[600px] flex items-center justify-center w-full">
    <div className="bg-base-300 p-8 rounded-lg shadow-md w-full max-w-xl">
      ...
      {success && <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">Comprador registrado exitosamente</div>}
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="nombre_comprador" className="block text-sm font-medium text-gray-200">
            Nombre Completo
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email_comprador" className="block text-sm font-medium text-gray-200">
            Correo Electrónico
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="celular_comprador" className="block text-sm font-medium text-gray-200">
            Teléfono
          </label>
          <input
            type="tel"
        ...
        <div>
          <label htmlFor="cc" className="block text-sm font-medium text-gray-200">
            Cédula
          </label>
          <input
            type="text"
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="w-full  text-white border border-red-700 py-2 px-4 rounded-md hover:bg-red-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Cancelar
          </button>
        </div>
